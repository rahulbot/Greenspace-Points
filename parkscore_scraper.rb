...
city_names.each do |city_name|
  ...
  csv << [city_name, acres, median_park_size, park_percentage, spending_per_capita, playgrounds_per_10k, 
          density, park_acres, people_per_park_acre, rank, population, 
